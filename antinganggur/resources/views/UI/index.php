            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-x-12 xl:gap-x-16 lg:items-center">
                <div class="lg:col-span-6 xl:col-span-6 text-center lg:text-left">
                    ...
                    <div class="mt-8 sm:flex sm:justify-center lg:justify-start sm:space-x-4 space-y-4 sm:space-y-0">
                        <a href="#" class="w-full sm:w-auto flex items-center justify-center px-8 py-3 border border-transparent text-base font-semibold rounded-lg text-white bg-[#FF7144] hover:bg-orange-600 md:text-lg md:px-10 shadow-md hover:shadow-lg transition-all duration-200">
                            Lihat Lowongan
                        </a>
                        <a href="#" class="w-full sm:w-auto flex items-center justify-center px-8 py-3 border-2 border-[#FF7144] text-base font-semibold rounded-lg text-[#FF7144] bg-white hover:bg-orange-50 hover:border-orange-600 hover:text-orange-600 md:text-lg md:px-10 shadow-sm hover:shadow transition-all duration-200">
                            Lamar Sekarang
                        </a>
                    </div>
                </div>
                <div class="mt-12 lg:mt-0 lg:col-span-6 xl:col-span-6">
                    <div class="relative mx-auto w-full max-w-md lg:max-w-lg xl:max-w-xl">
                        ...
                        <img class="relative w-full h-auto rounded-lg" src="../assets/Kerja.png" alt="Ilustrasi Temukan Pekerjaan Impian Anda">
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="py-16 md:py-20 lg:py-24 bg-[#FFF6F4]">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex flex-col rounded-xl shadow-lg overflow-hidden bg-white border border-gray-200 hover:shadow-2xl transition-shadow duration-300">
                        <div class="p-6 flex-grow">
                            <div class="flex items-start">
                                <span class="flex-shrink-0 inline-flex items-center justify-center h-12 w-12 rounded-lg bg-orange-100 text-orange-500">
                            ...
                            <div class="mt-4 flex flex-wrap gap-2">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-brand-tag-bg text-brand-tag-text">
                        ...
                        <div class="p-4 sm:p-6 bg-gray-50 border-t border-gray-200 flex space-x-3">
                            <a href="#" class="w-1/2 flex items-center justify-center px-4 py-2.5 border-2 border-orange-500 text-sm font-semibold rounded-lg text-orange-500 bg-white hover:bg-orange-50 hover:border-orange-600 hover:text-orange-600 shadow-sm transition-colors duration-150">
                                Lihat Detail
                            </a>
                            <a href="#" class="w-1/2 flex items-center justify-center px-4 py-2.5 border-2 border-orange-500 text-sm font-semibold rounded-lg text-white bg-orange-500 hover:bg-orange-600 hover:border-orange-600 shadow-sm hover:shadow-md transition-all duration-150">
                                Lamar
                            </a>
                        </div>
                    </div>
                ...
                <div class="mt-12 md:mt-16 text-center">
                    <a href="#" class="inline-flex items-center justify-center px-8 py-3.5 border-2 border-orange-500 text-base font-semibold rounded-lg text-orange-500 bg-white hover:bg-orange-50 hover:border-orange-600 hover:text-orange-600 md:text-lg md:px-10 shadow-sm hover:shadow transition-all duration-200">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="relative">
                        ...
                        <div class="bg-white p-6 py-8 md:p-10 rounded-xl shadow-2xl relative border border-gray-100">
                            ...
                            <div class="mt-8 flex flex-col items-center text-center sm:flex-row sm:items-center sm:justify-center sm:text-left">
                                <div class="flex-shrink-0">
                                    <div class="h-16 w-16 md:h-20 md:w-20 rounded-full bg-orange-100 flex items-center justify-center text-orange-500 text-2xl md:text-3xl font-bold ring-4 ring-white shadow-md">
                                        RA
                                    </div>
                                </div>
                                <div class="mt-4 sm:mt-0 sm:ml-6">
                                    <p class="text-lg font-bold text-orange-500">Rizky Amalia</p>
                    ...
                    <div class="flex justify-center space-x-3 mt-8 md:mt-10">
                        <button aria-label="Testimonial 1" class="h-3 w-3 bg-orange-500 rounded-full focus:outline-none ring-2 ring-orange-500 ring-offset-2 ring-offset-white"></button>
